...
class NRLMF:
    ...
    def update_D(self):
        ...
        for i in range(self.num_drugs):
            ...
            b = (self.W[i] * self.Y[i]) @ self.T + sim_term
    ...
    def update_T(self):
        ...
        for j in range(self.num_targets):
            ...
            b = (self.W[:, j] * self.Y[:, j]) @ self.D + sim_term
...
def main():
    ...
    molecule_data = molecule_data.loc[
        interaction_data.columns, interaction_data.columns
    ]
    protein_data = protein_data.loc[
        interaction_data.index, interaction_data.index
    ]
    ...
    print("Number of hard negatives:", len(low_prob_pairs_df))
